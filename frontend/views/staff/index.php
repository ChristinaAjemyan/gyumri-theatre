                            ...
                            <div class="col-md-12">
                                <nav>
                                    <div class="nav nav-tabs nav-fill p-0 row" id="nav-tab" role="tablist">
                                        <a class="nav-item col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 client_tab tab_main  <?=$role == 'administrative' ? 'active' : '' ?>" id="nav-home-tab" data-role="administrative"
                                           data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">
                                            <?= Yii::t('home', 'Վարչական Կազմ') ?>
                                            <div class="hove_height staff_change_line_adm">
                                                <div></div>
                                            </div>
                                        </a>
                                        <a class="nav-item col-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 client_tab tab_main <?=$role == 'artistic' ? 'active' : '' ?>" id="nav-profile-tab" data-role="artistic"
                                           data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">
                                            <?= Yii::t('home', 'Գեղ.-ստեղծագործական Կազմ') ?>
                                ...
                                <div class="tab-content" id="nav-tabContent #my_tab-content">
                                    ...
                                    <div class="tab-pane fade <?=$role == 'technical' ? 'show active' : '' ?>" id="nav-technical" role="tabpanel" aria-labelledby="nav-technical-tab">
                                        <div class="container main_container p-0">
                                            <div class="container main_container p-0">
                                                <?php if (!empty($model_staff_technical) && isset($model_staff_technical)): ?>
                                                    <div class="performance_movie" style="min-height: auto;">
                                                        <div class="row">
                                                            <?php foreach ($model_staff_technical as $item): ?>
                                                                <div class="col-lg-4 col-md-6 col-sm-12 p-0">
                                                                    <a href="javascript:void(0)">
                                                                        <div class="media_present staff_pres">
                                                                            <div class="media p-0">
                                                ...
                                                <div>
                                                    <?= LinkPager::widget([
                                                        'pagination' => $pages_staff_technical,
                                                        'maxButtonCount' => 6,
                                                        'prevPageLabel' => "<i class=\"fas fa-chevron-left\"></i>",
                                                        'nextPageLabel' => "<i class=\"fas fa-chevron-right\"></i>",
                                                        'options' => [
